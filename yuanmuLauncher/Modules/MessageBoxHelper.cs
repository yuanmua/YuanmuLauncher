...
namespace yuanmu.Modules
{
    public class MessageBoxHelper
    {
        ...
        /// <param name="Message">消息内容</param>
        /// <param name="Title">标题</param>
        public static void ShowMessage(string Message, string Title = "提示") => QModernMessageBox.Info(Message, Title);
        
        public static void ShowMessage(Window parentWindow, string Message, string Title = "提示") => QModernMessageBox.Info(parentWindow, Message, Title);
